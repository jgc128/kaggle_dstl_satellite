...
IMAGES_TEST_NORMALIZED_DATA_DIR = os.path.join(DATA_DIR, 'images_test_normalized/')
IMAGES_TEST_PREDICTION_MASK_DIR = os.path.join(DATA_DIR, 'images_test_prediction_mask/')
