...
from config import CLASSES_NAMES, IMAGES_NORMALIZED_SHARPENED_FILENAME, IMAGES_MASKS_FILENAME, IMAGES_METADATA_FILENAME, \
    IMAGES_MEANS_STDS_FILENAME, TENSORBOARD_DIR, MODELS_DIR
...
from utils.polygon import stack_masks, sample_patches, jaccard_coef
...
def config():
    ...
    model_name = 'jaccard_softmax_without_small_pansharpen'
...
@ex.named_config
def big_objects():
    model_name = 'jaccard_softmax_without_small_pansharpen_big_objects'
...
@ex.named_config
def small_objects():
    model_name = 'jaccard_softmax_without_small_pansharpen_small_objects'
